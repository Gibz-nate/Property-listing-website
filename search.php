         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <select name="min" class="input" required>
                  ...
                  <option value="15000">6,000</option>
                  <option value="20000">8,000</option>
                  <option value="30000">10,000</option>
                  <option value="40000">12,000</option>
                  <option value="40000">14,000</option>
                  <option value="50000">16,000</option>
            ...
            <div class="box">
               ...
               <select name="max" class="input" required>
                  ...
                  <option value="10000">8,000</option>
                  <option value="15000">12,000</option>
                  <option value="20000">16,000</option>
                  <option value="30000">20,000</option>
                  <option value="40000">24,000</option>
                  <option value="40000">28,000</option>
                  <option value="50000">32,000</option>
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            ...
            <div class="flex">
               ...
               <p><i class="fas fa-bed"></i><span><?= $fetch_property['bhk']; ?> B</span></p>
